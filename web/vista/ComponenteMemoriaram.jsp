...
<html>
    ...
    <body>
        <div class="container mt-5">
            <div class="row">
                <c:forEach var="mram" items="${MemoriaRAM}">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="${pageContext.request.contextPath}/img/${mram.getImagen()}" class="card-img-top" alt="MemoriaRAM">
                            <div class="card-body">
                                <h5 class="card-title">${mram.getNombre()}</h5>
                                <p class="card-text">S/.${mram.getPrecio()}</p>
