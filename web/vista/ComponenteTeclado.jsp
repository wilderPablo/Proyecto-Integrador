<%-- 
    Document   : ComponenteTeclado
    Created on : 5 jun. 2024, 11:26:03
    Author     : user
--%>
...
<html>
    ...
    <body>
        <div class="container mt-5">
            <div class="row">
                <c:forEach var="tcl" items="${Teclado}">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="${pageContext.request.contextPath}/img/${tcl.getImagen()}" class="card-img-top" alt="Teclado">
                            <div class="card-body">
                                <h5 class="card-title">${tcl.getNombre()}</h5>
                                <p class="card-text">S/.${tcl.getPrecio()}</p>
