...
<html>
    ...
    <body>
        <div class="container mt-5">
            <div class="row">
                <c:forEach var="prosc" items="${Procesador}">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="${pageContext.request.contextPath}/img/${prosc.getImagen()}" class="card-img-top" alt="Proceador">
                            <div class="card-body">
                                <h5 class="card-title">${prosc.getNombre()}</h5>
                                <p class="card-text">S/.${prosc.getPrecio()}</p>
